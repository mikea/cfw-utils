...
import { ISAACGenerator, newRandom } from "./random";
...
describe("random", () => {
  it("produces test hashes too", () => {
    const result = new Array<string>();
    const random = newRandom(new Array<number>(256).fill(0));
    for (let i = 0; i < 2; i++) {
      let str = "";
      for (let j = 0; j < 256; j++) {
...
const expectedHashes = `f650e4c8e448e96d98db2fb4f5fad54f433f1afbedec154ad837048746ca4f9a
