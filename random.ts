...
const maxU32 = 0xffffffff + 1;

export function newRandom(seed?: number[]): IRandom {
  ...
  return {
    ...
    real() {
      return this.randU32() * (1 / (maxU32 - 1));
    },

    realx() {
      return (this.randU32() + 0.5) * (1 / maxU32);
    },

    rnd() {
      return this.randU32() * (1 / maxU32);
    },
  };
}
